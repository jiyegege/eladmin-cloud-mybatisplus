...
@RestController
@Api(hidden = true)
@SpringBootApplication(scanBasePackages = "com.roger")
@EnableFeignClients(basePackages = "com.roger.api.service")
@EnableTransactionManagement
public class EladminLogApplication {

    public static void main(String[] args) {
        SpringApplication.run(EladminLogApplication.class, args);
    }
